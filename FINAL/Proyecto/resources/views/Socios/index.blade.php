    ...
    <tbody>
        @foreach($socios as $socio)
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <button type="button"class="btn btn-success abrir-modal" data-title="Detalle del Socio" data-url="{{ route('socios.show', $socio->SocioID) }}" data-action="" data-confirm-text="Cerrar">Ver</button>
                        <button type="button" class="btn btn-warning abrir-modal" data-url="{{ route('socios.edit', $socio->SocioID) }}" data-action="editarSocio" data-confirm-text="Editar socio" data-id="{{ $socio->SocioID }}" data-title="Editar socio">Editar</button>
                        <button type="button" class="btn btn-danger abrir-modal" data-url="{{ route('socios.show', $socio->SocioID) }}" data-action="eliminarSocio" data-confirm-text="Eliminar socio" data-id="{{ $socio->SocioID }}" data-title="Eliminar socio">Eliminar</button>
                    </div>
                </td>
                <td>
                    @if($socio->Activo)
